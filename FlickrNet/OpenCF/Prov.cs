...
namespace FlickrNet.OpenCF
{
    internal class Prov
    {
        ...
        {
            ArrayList alProv = new();
            ArrayList alProvType = new();
            uint dwIndex = 0;
            uint dwReserved = 0;
            uint dwFlags = 0;
            uint dwProvType = 0;
            uint cbProvName = 0;
            StringBuilder sProv = new();
            while (true)
            {
                ...
                sProv = new StringBuilder((int)cbProvName);
